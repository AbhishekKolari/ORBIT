...
#SBATCH -C A6000
#SBATCH --gres=gpu:1
#SBATCH --output=qwen2-5-vl_32b-1_notebook_%j.out
...
papermill /var/scratch/ave303/OP_bench/opa-benchmark-smolvlm2-qwen2-5-vl.ipynb qwen2-5-vl_32b-1_output.ipynb
