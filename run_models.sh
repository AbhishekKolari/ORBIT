...
#SBATCH -C A6000
#SBATCH --gres=gpu:1
#SBATCH --output=spaceqwen2-5-vl-3b_notebook_%j.out
...
papermill /var/scratch/ave303/OP_bench/opa-benchmark-smolvlm2-qwen2-5-vl.ipynb qwen2-5-vl-3b_output.ipynb
